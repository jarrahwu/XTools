...
public class CacheHttpRequest extends BaseHttpRequest {

    private static final int DEFAULT_EXPIRE = 24 * 60 * 60 * 1000; // one day
    private static long expire = DEFAULT_EXPIRE;
